...
for i, f in zip(range(len(possible_feature_sets)), feature_names):
    print("Feature set:", i)
    selected_train_X = np.ascontiguousarray(X_train[possible_feature_sets[i]])
    selected_test_X = np.ascontiguousarray(X_test[possible_feature_sets[i]])
...
# # This neural network has thesame accuracy score as the random forest. But second on the list... By plotting the confusion matrix, it performs better ....
# (
#     class_train_y,
#     class_test_y,
#     class_train_prob_y,
...
with open("../../src/random_forest.pickle","wb") as f:
    pickle.dump(rf, f)
